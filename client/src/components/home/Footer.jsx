export default function Footer() {
    return (
        <>
            ...
            <footer className="flex flex-wrap justify-center lg:justify-between overflow-hidden gap-10 md:gap-20 py-16 px-4 md:px-16 lg:px-24 xl:px-40 text-[13px] text-gray-500 bg-black">
                <div className="flex flex-wrap items-start gap-10 md:gap-[60px] xl:gap-[140px]">
                    ...
                    <div>
                        ...
                        <ul className="mt-2 space-y-2">
                            <li><a href="/" className="hover:text-green-500 transition">Templates</a></li>
                            <li><a href="/" className="hover:text-green-500 transition">Resume Tips</a></li>
                            <li><a href="/" className="hover:text-green-500 transition">Community</a></li>
                            <li><a href="/" className="hover:text-green-500 transition">Careers<span className="text-xs text-white bg-green-600 rounded-md ml-2 px-2 py-1">We're hiring!</span></a></li>
                        </ul>
                    </div>
                    <div>
                ...
                <div className="flex flex-col max-md:items-center max-md:text-center gap-2 items-end">
                    <p className="max-w-60">Empower your career with a professional resume that opens doors and gets you noticed.</p>
                    ...
                    <p className="mt-3 text-center">© 2026 Resumio. All rights reserved.</p>
                </div>
            </footer>
        </>
    );
